...
const WeatherComp = /*@__PURE__*/ proxyCustomElement(class WeatherComp extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return weatherCompCss; }
}, [1, "jji-weather-comp", {
    "tit": [513],
    "visible": [1540],
    "countryCityEnteredByUser": [1537, "country-city-entered-by-user"],
    "numbeOfDaysToForecast": [1538, "numbe-of-days-to-forecast"],
    "fetchedCountry": [32],
    "fetchedCity": [32],
    "fetchedCurrentDate": [32],
    "fetchedCurrentTemperature": [32],
    "fetchedCurrentWind": [32],
    "fetchedCurrentHumidity": [32],
    "fetchedPlusOneCurrentDate": [32],
    "fetchedPlusOneCurrentTemperature": [32],
    "fetchedPlusOneCurrentWind": [32],
    "fetchedPlusOneCurrentHumidity": [32],
    "fetchedPlusTwoCurrentDate": [32],
    "fetchedPlusTwoCurrentTemperature": [32],
    "fetchedPlusTwoCurrentWind": [32],
    "fetchedPlusTwoCurrentHumidity": [32],
    "countryUserInput": [32],
    "inputCityCountryValid": [32],
    "error": [32],
    "forecastData": [32],
    "numberOfDaysToBeForecasted": [32],
    "openWeatherComp": [64]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["jji-weather-comp"];
  components.forEach(tagName => { switch (tagName) {
    case "jji-weather-comp":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WeatherComp);
      }
      break;
  } });
}

const JjiWeatherComp = WeatherComp;
const defineCustomElement = defineCustomElement$1;

export { JjiWeatherComp, defineCustomElement };

//# sourceMappingURL=jji-weather-comp.js.map